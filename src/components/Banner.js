                    ...
                    <div className="container">
                        <div className="row pl-80 align-items-center justify-content-between">
                            <div className="col-12 col-xl-6 col-xxl-5">
                                <h1>Find the perfect<br /><span style={{color: "#0969C3"}}>Tuition</span> for you</h1>
                                <div className="hero-subtitle mt-3 mt-lg-4">Search your Online Classes opportunity</div>
    
                                <div className="hero-form hero-form-round mt-3 mt-lg-4">
                                    <form className="row gx-3 align-items-center" action="#">
                                        <div className="col-12 col-sm">
                                            <div className="mb-3 mb-sm-0">
                                                <input type="text" className="form-control" placeholder="Online Tuition or Hobby" />
                                            </div>
                                        </div>
                            ...
                            <div className="d-none d-xl-block col-xl-5 position-relative">
                                <div className="hero-cards-container animate-cards mouse-move" data-speed="160">
                                    <div className="hero-card cover cover-top animate" style={{ backgroundImage: `url(${Img})` }}></div>
